    ...
    <div>
      ...
      <main className="w-full min-h-screen bg-white">
        ...
        <section className="relative h-[90vh] w-full flex items-center justify-center">
          <Image
            src="https://res.cloudinary.com/dgznrfgvc/image/upload/v1757661709/image_fy9ymp.png"
        ...
        <section className="px-6 md:px-16 py-16 flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              just have a chat. Whether it’s a general enquiry or a
              collaboration request, feel free to reach out — our team will
