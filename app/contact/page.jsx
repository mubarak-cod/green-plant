  ...
  return (
    ...
    <main className="w-full min-h-screen bg-white">
      ...
      <section className="relative h-[50vh] w-full flex items-center justify-center">
        <Image
          src="https://res.cloudinary.com/dpsxbuxkr/image/upload/v1757023897/image_g9frn1.png" // <-- replace with your bg image
...
<section className="px-6 md:px-16 py-16 flex flex-col md:flex-row items-center gap-10">
  ...
  <div className="flex-1 w-full">
    <Image
      src="https://res.cloudinary.com/dpsxbuxkr/image/upload/v1757023971/image_ejemmn.png" // <-- replace with your image
      alt="Team discussion"
      width={600}
      height={400}
